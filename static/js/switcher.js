...
$(document).ready(function() {
	var e =  '<div class="switcher-container">'+
               ...
               '<div class="selector-box">'+
                    ...
                    '<div class="sw-image">'+
                        '<a href="#">'+
                            '<img src="static/img/wordpress-version.png" alt="img"/>'+
                        '</a>'+
                    ...
                    '<div class="sw-pattern pattern"><h3>Background pattern:</h3>'+
                        '<a href="#" class="sw-pattern" data-image="static/img/pattern/1.png"><img src="static/img/pattern/1.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="static/img/pattern/2.png"><img src="static/img/pattern/2.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="static/img/pattern/3.png"><img src="static/img/pattern/3.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="static/img/pattern/4.png"><img src="static/img/pattern/4.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="static/img/pattern/5.png"><img src="static/img/pattern/5.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="static/img/pattern/6.png"><img src="static/img/pattern/6.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="static/img/pattern/7.png"><img src="static/img/pattern/7.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="static/img/pattern/8.png"><img src="static/img/pattern/8.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="static/img/pattern/9.png"><img src="static/img/pattern/9.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="static/img/pattern/10.png"><img src="static/img/pattern/10.png" alt="image"></a>' +
                    '</div>'+               
                  '<div class="clearfix"></div>'+
               '</div>'+
            '</div>';
    ...
    setColor: function(e) {
        ...
        $(t.headLink).attr("href", "static/css/colors/" + e + ".css");
